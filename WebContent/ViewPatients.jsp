...
<table id="myTable" class="table table-striped" >
    <thead>
        <tr>
            <th>PID</th><th>Pname</th><th>Email</th><th>Contact No.</th><th>DOB</th><th>Gender</th><th>Status</th><th>Address</th><th>Registered Date</th><th>Action</th>
        </tr>
    </thead>
    <tbody>
        <%
        ...
        %>
        <tr>
            <td><%=pid%></td><td><%=name%></td><td><%=email%></td><td><%=contact%></td><td><%=dob%></td><td><%=gender%><%=status%><td><%=address%><td><%=Reg_Date%></td>
