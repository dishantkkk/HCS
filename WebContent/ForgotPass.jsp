                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="panel-body">
                                        <center><h3>Patient Forgot Password Form</h3></center>
                                        <%
                                    ...
                                    <div class="col-lg-6">
                                        <div class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
                                            <img src="images/Patienticon.jpg" class="img img-responsive" style="width: 190px;height: 190px;margin-bottom: 9px;" class="img img-responsive" alt="" />
                                        </div>
                                    </div>
                                    <form action="GetPass" method="post" role="form" class="contactForm lead">
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                                <div class="form-group">
                                                    <label>Patient ID</label>
                                                    <input required="" placeholder="Patient ID" type="text" title="Enter Patient ID" name="pid"  class="form-control input-md">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                                <div class="form-group">
                                                    <label>Email</label>
                                                    <input type="email" required="" placeholder="Email" id="txtEmail" name="email" id="last_name" class="form-control input-md" title="Enter your Patient Email-ID">
                                                    <div class="validation"></div>
                                                </div>
                                            </div>
                                        </div>
