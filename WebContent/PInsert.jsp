    ...
    <body>
        <table class="table table-banddered">
            ...
            <%
                ...
                Connection con = DB.getConnection();
                Statement st = con.createStatement();
                ResultSet rs = st.executeQuery("SELECT distinct disease FROM `symptoms` WHERE locate(symptom,'" + sym1 + "')>0 or locate(symptom,'" + sym2 + "')>0 or locate(symptom,'" + sym3 + "')>0 or locate(symptom,'" + sym4 + "')>0 or locate(symptom,'" + sym5 + "')>0 or locate(symptom,'" + sym6 + "')>0 or locate(symptom,'" + sym7 + "')>0 or locate(symptom,'" + sym8 + "')>0 or locate(symptom,'" + sym9 + "')>0 and gender='" + gender + "' and age_group='" + age + "' GROUP BY disease HAVING COUNT(*) > 0 order by count(*) DESC limit 0,5");
                int count = 0;
                while (rs.next()) {
                    count = count + 1;
            %>
            ...
            <%
                ...
                Connection con = DB.getConnection();
                Statement st = con.createStatement();
                ResultSet rs = st.executeQuery("SELECT distinct disease FROM `symptoms` WHERE locate(symptom,'" + sym1 + "')>0 or locate(symptom,'" + sym2 + "')>0 or locate(symptom,'" + sym3 + "')>0 or locate(symptom,'" + sym4 + "')>0 or locate(symptom,'" + sym5 + "')>0 or locate(symptom,'" + sym6 + "')>0 or locate(symptom,'" + sym7 + "')>0 or locate(symptom,'" + sym8 + "')>0 and gender='" + gender + "' and age_group='" + age + "' GROUP BY disease HAVING COUNT(*) > 0 order by count(*) DESC limit 0,5");
                int count = 0;
                while (rs.next()) {
                    count = count + 1;
            %>
            ...
            <%
                ...
                Connection con = DB.getConnection();
                Statement st = con.createStatement();
                ResultSet rs = st.executeQuery("SELECT distinct disease FROM `symptoms` WHERE locate(symptom,'" + sym1 + "')>0 or locate(symptom,'" + sym2 + "')>0 or locate(symptom,'" + sym3 + "')>0 or locate(symptom,'" + sym4 + "')>0 or locate(symptom,'" + sym5 + "')>0 or locate(symptom,'" + sym6 + "')>0 or locate(symptom,'" + sym7 + "')>0 and gender='" + gender + "' and age_group='" + age + "' GROUP BY disease HAVING COUNT(*) > 0 order by count(*) DESC limit 0,5");
                int count = 0;
                while (rs.next()) {
                    count = count + 1;
            %>
            ...
            <%
                ...
                Connection con = DB.getConnection();
                Statement st = con.createStatement();
                ResultSet rs = st.executeQuery("SELECT distinct disease FROM `symptoms` WHERE locate(symptom,'" + sym1 + "')>0 or locate(symptom,'" + sym2 + "')>0 or locate(symptom,'" + sym3 + "')>0 or locate(symptom,'" + sym4 + "')>0 or locate(symptom,'" + sym5 + "')>0 or locate(symptom,'" + sym6 + "')>0 and gender='" + gender + "' and age_group='" + age + "' GROUP BY disease HAVING COUNT(*) > 0 order by count(*) DESC limit 0,5");
                int count = 0;
                while (rs.next()) {
                    count = count + 1;
            %>
            ...
            <%
                ...
                Connection con = DB.getConnection();
                Statement st = con.createStatement();
                ResultSet rs = st.executeQuery("SELECT distinct disease FROM `symptoms` WHERE locate(symptom,'" + sym1 + "')>0 or locate(symptom,'" + sym2 + "')>0 or locate(symptom,'" + sym3 + "')>0 or locate(symptom,'" + sym4 + "')>0 or locate(symptom,'" + sym5 + "')>0 and gender='" + gender + "' and age_group='" + age + "' GROUP BY disease HAVING COUNT(*) > 0 order by count(*) DESC limit 0,5");
                int count = 0;
                while (rs.next()) {
                    count = count + 1;
            %>
            ...
            <%
                ...
                Connection con = DB.getConnection();
                Statement st = con.createStatement();
                ResultSet rs = st.executeQuery("SELECT distinct disease FROM `symptoms` WHERE locate(symptom,'" + sym1 + "')>0 or locate(symptom,'" + sym2 + "')>0 or locate(symptom,'" + sym3 + "')>0 or locate(symptom,'" + sym4 + "')>0 and gender='" + gender + "' and age_group='" + age + "' GROUP BY disease HAVING COUNT(*) > 0 order by count(*) DESC limit 0,5");
                int count = 0;
                while (rs.next()) {
                    count = count + 1;
            %>
            ...
            <%
                ...
                Connection con = DB.getConnection();
                Statement st = con.createStatement();
                ResultSet rs = st.executeQuery("SELECT distinct disease FROM `symptoms` WHERE locate(symptom,'" + sym1 + "')>0 or locate(symptom,'" + sym2 + "')>0 or locate(symptom,'" + sym3 + "')>0 and gender='" + gender + "' and age_group='" + age + "' GROUP BY disease HAVING COUNT(*) > 0 order by count(*) DESC limit 0,5");
                int count = 0;
                while (rs.next()) {
                    count = count + 1;
            %>
            ...
            <%
                ...
                Connection con = DB.getConnection();
                Statement st = con.createStatement();
                ResultSet rs = st.executeQuery("SELECT distinct disease FROM `symptoms` WHERE locate(symptom,'" + sym1 + "')>0 or locate(symptom,'" + sym2 + "')>0 and gender='" + gender + "' and age_group='" + age + "' GROUP BY disease HAVING COUNT(*) > 0 order by count(*) DESC limit 0,5");
                int count = 0;
                while (rs.next()) {
                    count = count + 1;
            %>
            ...
            <%
                ...
                Connection con = DB.getConnection();
                Statement st = con.createStatement();
                ResultSet rs = st.executeQuery("SELECT distinct disease FROM `symptoms` WHERE locate(symptom,'" + sym1 + "')>0 and gender='" + gender + "' and age_group='" + age + "' GROUP BY disease HAVING COUNT(*) > 0 order by count(*) DESC limit 0,5");
                int count = 0;
                while (rs.next()) {
                    count = count + 1;
            %>
            ...
            %>
            <tr>
                <td style="background-color: yellowgreen;color:black;"></td>
                <td style="background-color: yellowgreen;color:black;"><a href="BookApointment.jsp">Book Appointment</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="AskDoctor.jsp">Ask Doctor</a></td>
            </tr>
            <%
                } else {
                }
